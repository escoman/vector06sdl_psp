...
/*
 * CP866 8x8 font for the on-screen Vector-06C keyboard (VKBD).
 *
 * 256 glyphs, 8 bytes each, row-major; bit 7 of a row byte is the
 * leftmost pixel. Generated from the vector06sdl libretro core
 * CodePage866_8x8 font so the VKBD legends (Cyrillic, Latin,
 * arrows, special signs) match the original on-screen keyboard.
 */

#include <inttypes.h>

#define VKBD_FONT_W 8
#define VKBD_FONT_H 8

static const uint8_t vkbd_font[256][8] = {
    ...
    { 0xf8, 0xe0, 0xf0, 0xb8, 0x9c, 0x0e, 0x06, 0x00 },
